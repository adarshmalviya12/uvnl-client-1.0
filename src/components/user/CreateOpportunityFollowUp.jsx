...
const CreateOpportunityFollowUp = ({ opportunity, setFollowUps }) => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error creating opportunity follow-up:", error);
...
export default CreateOpportunityFollowUp;
